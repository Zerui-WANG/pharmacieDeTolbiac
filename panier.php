...
logged();
//Si la variable del passe dans l'url alors on supprime sa valeur =>ID_obj
if(isset($_GET['del'])){
	$panier->del($_GET['del']);
}
?>
...
<body>
	...
	<?php
		...
		//afin d'éviter une erreur au cas où le panier est vide
		if(empty($ids)){
			$produits = array();
		}else{
			//les produits avec les ID_obj de $ids
