...
<body>
<div>Veuillez rafraichir la page à chaque changement(F5) ou <a href='espacevendeur.php'>cliquez ici</a></div>
<h1>Espace Vendeur</h1>
<h2>Produits mise en vente</h2>
<?php 
...
<table>
<tr>
	<td><label>Code produit : </label></td>
